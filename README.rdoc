...
This gem currently depends on the em-http-request 1.0 release. As of this writing, em-http-request 1.0 is in pre-release, so you have to install that manually.
