class MessageGateway
  module Parser
    class UnwiredAppeal < SimpleCarrier
      # Unwired Appeal happens to use logical parameter values for
      # the information they pass in. The subclass implementations of `from_value`
      # etc are fine. WD-rpw 12-20-2011
