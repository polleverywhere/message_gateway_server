  ...
  module Util
    module Carrier
      ...
      class CarrierInfo
        ...
        register                  :telus,                 "TELUS Mobility"
        register                  :telebec,               "Telebec"
        register                  :sasktel,               "SaskTel Mobility"
        register                  :boost_cdma,            "boost_cdma"
        register                  :rogers,                "Rogers Cantel Inc"
        register                  :boost_iden,            "boost_iden"
        register                  :northtel,              "Northern Telephone"
        register                  :mts,                   "MTS"
        register                  :voce,                  "voce"
        register                  :fido,                  "Fido/Microcell Connexions"
        register                  :bell,                  "Bell Mobility"
        register                  :suncom,                "SunCom Wireless"
        register                  :aliant,                "Aliant Telecom"
        register                  :npi,                   "NPI Wireless"
        register                  :nbtel_mobility,        "NBTel Mobility"
        register                  :midwest,               "Midwest Wireless"
        ...
        register                  :iowa,                  "Iowa Wireless Svc"
